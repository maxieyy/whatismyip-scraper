...
def get_whatismyip_data(ip_address):
    ...
    # Try different impersonations if one fails
    impersonations = ["chrome110", "chrome99", "safari15_3", "edge101"]
    ...
    # If all impersonations fail
    return {
        'success': False, 
        'error': 'Unable to fetch IP data. All browser impersonations failed.', 
        'developer': DEVELOPER
    }
